  ...
  return (
    <div className="flex flex-1 flex-col">
      <div className="flex flex-1 flex-col">
        ...
        {dropdownOpen && (
          <div
            className="absolute bg-zinc-800 border border-zinc-700 rounded shadow-xl z-[9999] min-w-[200px] max-h-[300px] overflow-y-auto"
            style={{
              ...
              left: dropdownRef.current
                ? dropdownRef.current.getBoundingClientRect().left +
                  window.scrollX
                : 0,
              minWidth: dropdownRef.current
                ? Math.max(dropdownRef.current.offsetWidth, 200) + "px"
                : "200px",
            }}>
            {authTypes.map((type) => (
              <button
    ...
    <div className="p-3 space-y-3">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-1.5 text-xs bg-zinc-800 border border-zinc-700 rounded 
                   text-zinc-100 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-transparent">
